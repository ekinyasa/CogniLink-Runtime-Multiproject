...
(function () {
  ...
  function populateEngineForm() {
    ...
    $("e-redir-hot").value = redirects.hot || "https://pages.niluferormanli.com/checkout";
    $("e-redir-conv").value = redirects.converted || "https://pages.niluferormanli.com/tesekkurler";
